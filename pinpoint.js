function pinpoint(canvas, location, color, size) {
...
// You can easily configure a function to the above using your preferred settings, but hue combos other than these might not work as intended: R G B, R↔G B, G↔B R, B↔R G
